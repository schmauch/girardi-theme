...
<header>
    <a id="logo" href="/" style="color: black;">
        <svg
           width="748.74609"
           height="320"
           viewBox="0 0 748.74608 319.99999"
           version="1.1"
           id="svg24"
          ...
          <g
             id="g1455"
             transform="scale(0.22069407)">
            <path
               d="m 11.82414,127.3105 a 702.5,702.5 0 1 1 0,1195.35 M 22.5,1341.8031 V 108.16788 Z"
               stroke="currentColor"
               stroke-width="45"
               fill="none"
               id="path2" />
            <path
               d="m 1078.5,702.4855 h -685 v 106 H 632.0728 C 595.3441,937.3469 468.0492,1018.3867 335.78388,997.1347 203.52166,975.8832 108.10176,859.0605 113.57419,725.187 119.04662,591.3134 223.68309,482.66849 357.23855,472.28299 490.7971,461.89725 611.0529,553.0564 637.1416,684.4855 h 441.9877 c 1.2017,5.9851 -1.6746,11.9856 -0.6293,18 z"
               stroke="currentColor"
               stroke-width="45"
               fill="currentColor"
               id="path4" />
            <g
               ...
               transform="translate(-403.656,-475.0145)">
              <path
        ...
        <?php
            ...
            'items' => [
                ['label' => 'Aktuell', 'url' => ['/cms/site/render', 'url' => 'aktuell'], 'items' => [
                    ['label' => 'Kochschublade', 'url' => ['/cms/site/render', 'url' => 'kochschublade ']],
                    ['label' => 'Tische aus Massivholz', 'url' => ['/cms/site/render', 'url' => 'tische-aus-massivholz ']],
                    ['label' => 'Girardi Lounge', 'url' => ['/cms/site/render', 'url' => 'lounge ']],
                    ['label' => 'Draussen geniessen – dank der Schreinerei Girardi', 'url' => ['/cms/site/render', 'url' => 'draussen-geniessen-dank-der-schreinerei-girardi ']],
                    ['label' => '75 Jahre Dienstjubiläum', 'url' => ['/cms/site/render', 'url' => '75-jahre-dienstjubilaeum ']],
                    ['label' => 'offene Stellen', 'url' => ['/cms/site/render', 'url' => 'offene-stellen ']],
                    ['label' => 'Zeit für eine neue Küche', 'url' => ['/cms/site/render', 'url' => 'neue-kueche ']],
                    ['label' => 'Abschied nach 26 Jahren', 'url' => ['/cms/site/render', 'url' => 'abschied-zeno-anselm ']],
                    ['label' => 'Ausstellungsverkauf', 'url' => ['/cms/site/render', 'url' => 'ausstellungsverkauf ']],
                    ['label' => 'Weihnachten 2019', 'url' => ['/cms/site/render', 'url' => 'weihnachten2019 ']],
                    ['label' => 'Infos zum Corona-Virus', 'url' => ['/cms/site/render', 'url' => 'coronavirus ']],
                    ['label' => 'Lehrstellenforum 2023', 'url' => ['/cms/site/render', 'url' => 'lehrstellenforum-2023 ']],
                    ['label' => 'Neue Kreissäge', 'url' => ['/cms/site/render', 'url' => 'eine-neue-kreissaege-ohne-digitalen-schnickschnack ']],
                    ['label' => 'Ämtler-Bon', 'url' => ['/cms/site/render', 'url' => 'aemtler-bon ']],
                    ['label' => 'Drei Dienstjubiläen und sowas Ähnliches', 'url' => ['/cms/site/render', 'url' => 'drei-dienstjubilaeen-und-sowas-aehnliches ']],
                    ['label' => 'Weihnachten 2023', 'url' => ['/cms/site/render', 'url' => 'weihnachten-2023 ']],
                    ['label' => 'Jubiläums-Aktion: 100% Rabatt auf ein Küchengerät von Miele', 'url' => ['/cms/site/render', 'url' => 'jubilaeums-aktion ']],
                    ['label' => 'Rampenverkauf, Fabrikverkauf, Restposten', 'url' => ['/cms/site/render', 'url' => 'rampenverkauf ']],
                    ['label' => 'Ämtler Berufsmesse', 'url' => ['/cms/site/render', 'url' => 'berufsmesse2025 ']],
                    ['label' => '8. Ämtler Berufsmesse', 'url' => ['/cms/site/render', 'url' => 'aemtler-berufsmesse-2019 ']],
                    ['label' => 'Adventsfenster', 'url' => ['/cms/site/render', 'url' => 'adventsfenster2018 ']],
                    ['label' => 'Grand Prix du Vin Suisse 2018', 'url' => ['/cms/site/render', 'url' => 'grand-prix-du-vin-suisse-2018 ']],
                    ['label' => 'Träffpunkt Rössli', 'url' => ['/cms/site/render', 'url' => 'traeffpunkt-roessli ']],
                    ['label' => 'Abschied von Roman Gianola', 'url' => ['/cms/site/render', 'url' => 'abschied-roman-gianola ']],
                    ['label' => 'Abschied von Geri Huber', 'url' => ['/cms/site/render', 'url' => 'abschied-geri-huber ']],
                    ['label' => 'Vom Baum zum Tisch', 'url' => ['/cms/site/render', 'url' => 'birnbaumtisch ']],
                    ['label' => 'Personelle Wechsel', 'url' => ['/cms/site/render', 'url' => 'personelle-wechsel ']],
                    ['label' => 'Adventsfenster 2020', 'url' => ['/cms/site/render', 'url' => 'adventsfenster2020 ']],
                    ['label' => 'Weihnachten 2020', 'url' => ['/cms/site/render', 'url' => 'weihnachten-2020 ']],
                    ['label' => 'April April!', 'url' => ['/cms/site/render', 'url' => '1april ']],
                    ['label' => 'Lehrstellenforum 2021', 'url' => ['/cms/site/render', 'url' => 'lehrstellenforum-2021 ']],
                    ['label' => 'Weihnachten 2021', 'url' => ['/cms/site/render', 'url' => 'weihnachten2021 ']],
                    ['label' => 'Rund um die Birne', 'url' => ['/cms/site/render', 'url' => 'rund-um-die-birne ']],
                    ['label' => 'Tage der Sonne', 'url' => ['/cms/site/render', 'url' => 'hedinger-energie-hautnah-erleben ']],
                ]],
